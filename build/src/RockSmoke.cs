...
namespace DuckGame.othello7_mod
{
    public class RockSmoke : Thing
    {
        ...
        public RockSmoke(float xpos, float ypos)
          : base(xpos, ypos, (Sprite)null)
        {
            ...
            Sprite graphic1 = new Sprite("Rock01", -2.0f, -2.0f);
            graphic1.depth = (Depth)1f;
            graphic1.CenterOrigin();
            graphicList.Add(graphic1);
            Sprite graphic2 = new Sprite("Rock01", 0.0f, 0.0f); 
            ...
            this.depth = (Depth)1f;
            this._backgroundSmoke = new Sprite("smokeBack", 0.0f, 0.0f);
        }
