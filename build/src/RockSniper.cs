...
namespace DuckGame.othello7_mod
{
    ...
    public class RockSniper : Gun
    {
        private SpriteMap _barrelSteam;
        private SpriteMap _netGunGuage;

        public RockSniper(float xval, float yval)
          : base(xval, yval)
        {
            this.ammo = 6;
            ...
            this._type = "gun";
            base.graphic = new Sprite(this.GetPath("RockSniper.png"), 0f, 0f);
        ...
        public override void Draw()
        {
            ...
            this.Draw((Sprite)this._netGunGuage, new Vec2(-10f, -4f), 1);
        }
        ...
        public override void OnPressAction()
        {
            ...
            {
                --this.ammo;
                SFX.Play((GetPath("SFX\\rocksniperfire")), 1f, 0.0f, 0.0f, false);
                ...
                net.hSpeed = this.barrelVector.x * 300000000000000000000000000000000000000f * 300000000000000000000000000000000000000f * 300000000000000000000000000000000000000f;  
